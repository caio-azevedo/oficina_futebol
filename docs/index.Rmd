...
* Nossa estratégia inicial foi em não pivotear, no entanto, poderíamos ter optador em utilizar a função *pivot_longer*. A base de dados anteriormente estava da seguinte maneira:
